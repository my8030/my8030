public class Application {
    public static void main(String[] args) {
        ...
        UserDB.userInfo("Nasayalnika");
        UserDB.userInfo("Nasayalnika2");
        System.out.println("\n");
        UserDB.changeUserRatingByName("Petro", UserRating.OUR_BOSS);
        UserDB.premiumStatus("Djamshut", false);
        UserDB.deleteUserByName("Nasayalnika");
        UserDB.fullInfo();
        System.out.println("\n");
        UserDB.sortUsersAlphabetically();
    }
}
