...
public class ConsoleMenu implements NewTransaction {
    private static TransactionsDB receipt= new TransactionsDB();
    ...
    public static void newTransaction(){
        receipt.addTransaction(NewTransaction.senderName(), NewTransaction.receiverName(), NewTransaction.sum(), NewTransaction.comment());
    }

    public static void newAnonymousTransaction(){
        receipt.addAnonymousTransaction(NewTransaction.senderName(), NewTransaction.receiverName(), NewTransaction.sum(), NewTransaction.comment());
    }
